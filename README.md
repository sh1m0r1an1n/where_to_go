...
![Демонстрация работы карты](docs/demo.gif)
...
- **Фронтенд**: [where-to-go-frontend](https://github.com/devmanorg/where-to-go-frontend) - готовая фронтенд-часть проекта
- **Данные**: [where-to-go-places](https://github.com/devmanorg/where-to-go-places) - готовые JSON файлы с данными о местах
